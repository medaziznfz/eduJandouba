      ...
      <div class="p-3">
        <div class="row align-items-center">
          ...
          <div class="col-auto dropdown-tabs">
            <span class="badge bg-light text-body fs-13">{{ auth()->user()->unreadNotifications->count() }} New</span>
          </div>
        </div>
      </div>
      ...
      <div class="tab-pane fade py-2 ps-2" id="all-noti-tab" role="tabpanel">
        <div data-simplebar style="max-height: 300px;" class="pe-2">
          @foreach(auth()->user()->notifications as $notification)
            <div id="notification-{{ $notification->id }}"
                 class="text-reset notification-item d-block dropdown-item position-relative {{ $notification->read ? '' : 'bg-info-subtle' }}">
              <div class="d-flex">
                <div class="avatar-xs me-3 flex-shrink-0">
                  <span class="avatar-title bg-info-subtle text-info rounded-circle fs-16">
                    <i class="bx bx-badge-check"></i>
                ...
                <div class="flex-grow-1">
                  <a href="{{ $notification->redirect_link }}" class="stretched-link"
                     onclick="markAndGo({{ $notification->id }}, '{{ $notification->redirect_link }}')">
                    <h6 class="mt-0 mb-2 lh-base">{{ $notification->title }}</h6>
                    <p class="fs-12 mb-1 text-muted">{{ $notification->subtitle }}</p>
                  </a>
                  <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                        ...
                        @elseif(auth()->user()->role === 'super')
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#">
                                    <i class="ri-shield-user-line"></i> <span>Supervision</span>
                                </a>
                            </li>
                        @endif
                    </ul>
